...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO productos (nombre, descripcion, cantidad, precio, categoria)
        ...
        <div class="tabla_seccion">
            <table>
                ...
                <tbody>
                    ...
                    $sql = "SELECT ID_Producto,productos.Nombre as Nombre, Descripcion, Cantidad, Precio,categorias.Nombre as Categoria FROM productos
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>";
                            echo "<button ><i class='fa fa-pencil-square-o' aria-hidden='true'><span class='badge badge-danger'></span></i></button>";
